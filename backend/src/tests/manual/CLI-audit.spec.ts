...
class MockGovernanceRepository {
    async findOpenViolation(): Promise<unknown> { return null; }
    async createViolation(): Promise<unknown> { return { id: "1" }; }
    async updateViolation(): Promise<unknown> { return { id: "1" }; }
    async findOpenViolations(): Promise<unknown> { return []; }
    async getHistory(): Promise<unknown> { return []; }
    async getViolations(): Promise<unknown> { return []; }
}
