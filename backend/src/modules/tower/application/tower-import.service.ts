      ...
      const skeletonData = data.map((element, index) => {
        ...
        return {
          ...
          metadata: {
            trecho: element.trecho || "",
            towerType: element.towerType || "Autoportante",
            foundationType: element.foundationType || "",
            concreteVolume: element.totalConcreto ?? element.concreteVolume ?? 0,
            steelWeight: element.steelWeight ?? 0,
            structureWeight: element.pesoEstrutura ?? 0,
