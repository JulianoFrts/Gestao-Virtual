 ...
 * v98.4: Forensic Sync & Smart Restore Protocol
 */
export async function POST(request: NextRequest) {
    ...
    console.log(`💣 [PANIC/v98.4] Ação: ${action}`);
    ...
    try {
        ...
        try {
            if (action === "nuke") {
                console.log("💣 [PANIC] Executando Nuke de Emergência (v98.4)...");
            ...
            if (action === "sync") {
                ...
                return NextResponse.json({
                    message: "Sync and Restore finished successfully (v98.4)! 🏆",
