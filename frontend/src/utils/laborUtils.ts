...
export const isDirectLabor = (functionName?: string): boolean => {
    if (!functionName) return true; // Default to MOD if unknown? Or MOI? Construction usually defaults to MOD.
 ...
 */
export const getLaborClassification = (functionName?: string): 'MOD' | 'MOI' => {
